...
public class GetOrderStatusTask extends AsyncTask<String, Void, Integer> {
	...
	public GetOrderStatusTask(Context context, Handler handler, String orderID) {
	...
	protected Integer doInBackground(String... params) {
		...
		message = new Message();
		String url = UrlConstants.GET_PAY_RESULT_URL;
		try {
			...
			if (code == HttpStatus.SC_OK) {
				...
				if (errorCode == 1) {
					message.arg1 = jsonObject.getInt("ispay");
				} else {
